...
public class Slope {
  ...
  public static String printEquation(int x, int y, int x2, int y2, String n, String b) {
    ...
    if (slope == -1) {
      System.out.println("Equation of the line: " + n + "=" + "-" + b + calcYIntercept(x, y, x2, y2));
    }
    if (slope == 1) {
      System.out.println("Equation of the line: " + n + "=" + b + calcYIntercept(x, y, x2, y2));
    }
    if (cept == 0) {
      System.out.println("Equation of the line: " + n + "=" + calcSlope(x, y, x2, y2) + b);
    }
